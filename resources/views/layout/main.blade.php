      ...
      <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('fakultas') }}">
              ...
              {{-- <div class="badge badge-info badge-pill">2</div>  untuk menampilkan tanda 2 seperti notif--}}
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ asset ("http://www.bootstrapdash.com/demo/spica/template/") }}">
